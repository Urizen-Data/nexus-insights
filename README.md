...
| :--- | :--- |
| **24/7 без засыпания** | Внешний cron-job пингует контейнер каждые 10 минут |
| **Десктоп и мобильные** | Адаптивный viewport с поддержкой pinch-to-zoom на телефонах |
| **Автообновление** | `git push` в Space → автоматическая пересборка Docker-образа |
---
